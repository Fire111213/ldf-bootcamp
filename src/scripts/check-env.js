...
if (missingVars.length > 0) {
  ...
  // Check for .env file in development only
...
`;
  ...
  // DON'T exit in production - let the build continue
  console.log('⚠️  Continuing build - make sure to set env vars in Netlify dashboard');
} else {
